// components/dashboard/booker/index.tsx
"use client";
...
import { BookerDashboardSkeleton } from "../skeletons/BookerDashboardSkeleton";
    ...
    >
      ...
      <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-4 relative z-10">
        <div className="space-y-2">
          ...
          >
            Manage your events, artists, and commissions
          </motion.p>
        </div>
            ...
            <div className="relative z-10 space-y-4 max-w-md">
              ...
              <div className="space-y-3">
                <h3 className={cn("text-xl font-bold", colors.text)}>
                  Unlock Pro Management Tools
                </h3>
                <p className={cn("text-sm leading-relaxed", colors.textMuted)}>
                  Upgrade to Pro and get advanced event management tools, artist
                  roster analytics, and commission tracking to grow your talent
                  management business.
                </p>
              </div>
      ...
      {/* Upgrade Modal */}
      <AnimatePresence>
        {showUpgradeModal && !user?.firstname && (
          <motion.div
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
            exit={{ opacity: 0 }}
              ...
              >
                ...
                <div className="p-6 space-y-6">
                  <div className="space-y-4">
                    ...
                    >
                      Complete your booker profile to showcase your expertise
                      and attract more artists and clients. Professional bookers
                      with complete profiles receive up to{" "}
                    ...
                    <div className="space-y-2">
                      <div className="flex justify-between text-xs">
                        ...
                        <span className={cn("font-semibold", colors.textMuted)}>
                          50%
                        </span>
                      </div>
                ...
                >
                  <p className={cn("text-xs", colors.textMuted)}>
                    Takes only 2 minutes • Boost your credibility instantly
                  </p>
                </div>
              </motion.div>
            )}
...
export default function BookerDashboardWithLoading({
  managedBands,
  artistsManaged,
