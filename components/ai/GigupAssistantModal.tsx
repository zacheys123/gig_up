...
// Enhanced version information with gradients for both themes
    ...
    >
      ...
      >
        ...
        <div className="flex items-center gap-4 relative z-10 flex-1">
          ...
          <div className="flex-1">
            ...
            <div className="flex items-center gap-3 mb-2">
              ...
              <span className="text-white/80 text-sm">{versionInfo.name}</span>
            </div>
            ...
            <div className="flex items-center gap-4 flex-wrap">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-white/70 text-xs">
                  {Math.round((questionUsage.used / questionUsage.limit) * 100)}
                  %
                </span>
              </div>
            </div>
        ...
        <button
          ...
          className="relative z-10 w-10 h-10 rounded-full bg-white/20 hover:bg-white/30 transition-all duration-200 flex items-center justify-center group ml-4"
        >
            ...
            <div className="space-y-4">
              <div className="flex justify-center">
                ...
                >
                  ...
                  <span className="font-bold text-lg">{versionInfo.name}</span>
                </div>
              </div>

              <p className={cn("text-base leading-relaxed px-4", colors.text)}>
                {getWelcomeMessage()}
              </p>
