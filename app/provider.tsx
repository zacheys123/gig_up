      ...
      <ClerkProvider
        ...
        appearance={{
          ...
          elements: {
            ...
            // Alert messages
            alert:
              "bg-blue-900 border border-blue-700 text-blue-200 rounded-lg p-3",
            alertError:
              "bg-red-900 border border-red-700 text-red-200 rounded-lg p-3",
            ...
            // Back link
            backLink:
              "text-indigo-400 hover:text-indigo-300 flex items-center gap-2 text-sm",
          },
        }}
      >
